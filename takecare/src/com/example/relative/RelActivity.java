...
public class RelActivity extends Activity implements OnClickListener {
	...
	public void createNotification() {
		...
		Intent resultIntent = new Intent(this, RelActivity.class);
		...
		stackBuilder.addParentStack(RelActivity.class);
